...
const (
	...
	Product_PostProduct_FullMethodName = "/Product/PostProduct"
)
...
func (c *productClient) PostProduct(ctx context.Context, in *PostProductReq, opts ...grpc.CallOption) (*PostProductResp, error) {
	out := new(PostProductResp)
	err := c.cc.Invoke(ctx, Product_PostProduct_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductServer) PostProduct(context.Context, *PostProductReq) (*PostProductResp, error) {
...
func _Product_PostProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Product_PostProduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServer).PostProduct(ctx, req.(*PostProductReq))
	}
	return interceptor(ctx, in, info, handler)
}
